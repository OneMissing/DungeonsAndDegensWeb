...
import { Character, Structure, tileCategories, SidebarProps } from "@/lib/map/types";
				...
				<div className="relative flex flex-col h-[100%-10rem] overflow-y-auto">
					...
					{activeTab === "characters" && (
						<div
							...
							{champions.map((char) => (
								<button key={char.id} onClick={() => addCharacter(char)} className="p-2 border border-border-light dark:border-border-dark rounded-md">
									<NextImage
										alt={char.name}
