								...
								{Object.entries(Races).map(([key, value]) => (
									<label
										...
										<input
											...
											name="race"
											value={value}
											checked={charData.race === value}
											onChange={() => handleChange("race", value)}
											className="hidden"
											required
										/>
			...
			content: (
				<div className="p-4 bg-gray-900 rounded-lg">
					...
					<div className="mt-4">
						<p className="text-sm">
							Total Points Used:{" "}
							{(["strength", "dexterity", "constitution", "intelligence", "wisdom", "charisma"] as (keyof CharData)[]).reduce(
								(sum, attr) => sum + (charData[attr] as number),
								0
							)}{" "}
							/ 72
						</p>
